...
class BusinessExceptionMapper extends ClassMapperBase<BusinessException> {
  ...
  static const Field<BusinessException, String> _f$message = Field(
    'message',
    _$message,
  );
  static dynamic _$data(BusinessException v) => v.data;
  static const Field<BusinessException, dynamic> _f$data = Field(
    'data',
    _$data,
    opt: true,
  );
...
mixin BusinessExceptionMappable {
  ...
  get copyWith =>
      _BusinessExceptionCopyWithImpl<BusinessException, BusinessException>(
        this as BusinessException,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return BusinessExceptionMapper.ensureInitialized().stringifyValue(
      this as BusinessException,
    );
  }
  ...
  bool operator ==(Object other) {
    return BusinessExceptionMapper.ensureInitialized().equalsValue(
      this as BusinessException,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return BusinessExceptionMapper.ensureInitialized().hashValue(
      this as BusinessException,
    );
  }
}
...
extension BusinessExceptionValueCopy<$R, $Out>
  ...
  get $asBusinessException => $base.as(
    (v, t, t2) => _BusinessExceptionCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class BusinessExceptionCopyWith<
  $R,
  $In extends BusinessException,
  $Out
>
