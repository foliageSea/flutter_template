...
class LoginFormDtoMapper extends ClassMapperBase<LoginFormDto> {
  ...
  static const Field<LoginFormDto, String> _f$username = Field(
    'username',
    _$username,
    opt: true,
    def: "",
  ...
  static const Field<LoginFormDto, String> _f$password = Field(
    'password',
    _$password,
    opt: true,
    def: "",
...
mixin LoginFormDtoMappable {
  String toJson() {
    return LoginFormDtoMapper.ensureInitialized().encodeJson<LoginFormDto>(
      this as LoginFormDto,
    );
  }

  Map<String, dynamic> toMap() {
    return LoginFormDtoMapper.ensureInitialized().encodeMap<LoginFormDto>(
      this as LoginFormDto,
    );
  }
  ...
  @override
  String toString() {
    return LoginFormDtoMapper.ensureInitialized().stringifyValue(
      this as LoginFormDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return LoginFormDtoMapper.ensureInitialized().equalsValue(
      this as LoginFormDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return LoginFormDtoMapper.ensureInitialized().hashValue(
      this as LoginFormDto,
    );
  }
}
