...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 2215562967307840487),
    name: 'User',
    lastPropertyId: const obx_int.IdUid(2, 5021294917533414774),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 564500130420648801),
        name: 'id',
        type: 6,
        flags: 1,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    retiredIndexUids: const [5744427149605530244],
